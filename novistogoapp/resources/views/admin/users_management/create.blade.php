<x-app-layout> {{-- Assuming you have an app layout, or use your admin layout --}}
    <x-slot name="header">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.users.management.store') }}">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('admin.users.management.index') }}" class="underline text-sm text-gray-600 hover:text-gray-900 mr-4">
                                {{ __('Cancel') }}
                            </a>
                            <x-primary-button>
                                {{ __('Create User') }}
